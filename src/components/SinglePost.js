    ...
    <main className="bg-gray-200 min-h-screen p-12">
      <article className="container shadow-lg mx-auto bg-green-100 rounded-lg">
        <header className="relative">
          ...
          <img className="w-full object-cover rounded-t" src={singlePost.mainImage.asset.url} 
          alt={singlePost.title}
          style={{height: "400px"}}/>
        </header>
        <div className="bg-purple-800 px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full text-black">
          <BlockContent 
